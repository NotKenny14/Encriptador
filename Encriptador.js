function encriptar(traduccion) {
    ...
    var textarea = document.querySelector("#data"); // Ajuste del ID
    const texto = textarea.value;
    var area_default = document.querySelector("#data");
    var area_result = document.querySelector("#texto_out");
    ...
    if (texto != "") {
        ...
        area_result.value = out; // Actualiza el valor del área de texto
    }
